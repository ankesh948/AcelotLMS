...
import Sales_traning_section_one from '../components/Sales_traning_section_one'
import Sales_traning_section_two from '../components/Sales_traning_section_two'
import Sales_traning_section_three from '../components/Sales_traning_section_three'
...
function Sales_traning() {
    return (
        <>
            ...
            <Sales_traning_section_six />
        </>
    )
}

export default Sales_traning