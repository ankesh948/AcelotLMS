...
function Privacy_policy() {
    return (
        <>
                    ...
                    <div class="align-items-center row">
                        <div class="mb-4 mb-lg-0 col-lg-6">
                            <div class="left_banner">
                                <p class="fs-3 mb-0 text-white">AcelotLMS</p>
                                <h1 class="text-white lead mb-3">Privacy Policy</h1>
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="right_banner contactbg text-center">
            ...
            <section className='privacy_policy_one'>
                <Container>
                    <Row>
                        <Col lg={12}>
                            ...
                            <p>We value your trust. In order to honour that trust, Acelot adheres to ethical standards in gathering, using, and safeguarding any information you provide. Acelot Innovation Private Limited (hereinafter referred to as the “<strong>Company</strong>”), is a leading edtech company, incorporated in India, for imparting learning. This privacy policy governs your use of the website: www.acelotacademy.com (“<strong>Website</strong>”) and the other associated applications (whether mobile or otherwise) (“<strong>Applications</strong>”), products, websites and services managed by the Company. Please read this privacy policy (“<strong>Policy</strong>”) carefully before using the Application, Website, our services and products, along with the Terms of Use (“<strong>ToU</strong>”) provided on the Application and the Website. Your use of the Website, Application, or services in connection with the Application, Website or products (“<strong>Services</strong>”), or registrations with us through any modes or usage of any products shall signify your acceptance of this Policy and your agreement to be legally bound by the same. If you do not agree with the terms of this Policy, do not use the Website, Application our products or avail any of our Services.</p>

                            <p><strong>User Provided Information</strong></p>

                            <p>The Application/Website/Services/products obtains the information you provide when you download and register for the Website, Application or Services or products. When you register with us, you generally provide: (a) your name, age, email address, location, phone number, password and your educational interests; (b) transaction-related information, such as when you make purchases, respond to any offers, or download or use Applications from us; (c) information you provide us when you contact us for help; (d) information you enter into our system when using the Website/Application/Services/products, such as while asking doubts, participating in discussions and taking tests. The said information collected from the users could be categorized as ‘Personal Information’ or ‘Sensitive Personal Data or Information’. ‘Personal Information’ or ‘Sensitive Personal Data or Information’ (each as individually defined under this Information Technology (Reasonable security practices and procedures and sensitive personal data or information) Rules, 2011 (the “<strong>Data Protection Rules</strong>”)) shall collectively be referred to as “<strong>Information</strong>” in this Policy. We may use the Information to contact you from time to time, to provide you with the Services, important information, required notices and marketing promotions. We will not differentiate between who is using the device to access the Application, Website or Services or products, so long as the log in/access credentials match with yours. In order to make the best use of the Application/Website/Services/products and enable your Information to be captured accurately on the Application/Website/Services/products, it is essential that you have logged in using your own credentials. We will, at all times, provide the option to you to not provide the Personal Information or Sensitive Personal Information, which we seek from you. Further, you shall, at any time while using the Application/Website/Services/products, also have an option to withdraw your consent given earlier to us to use such Information. Such withdrawal of the consent is required to be sent in writing to us at the contact details provided in this Policy below. In such event, however, the Company fully reserves the right not to allow further usage of the Website, Application or provide any Services/products thereunder to you.</p>

                            <p><strong>Automatically Collected Information</strong></p>

                            <p>In addition, the Website/Application/products/Services may collect certain information automatically, including, but not limited to, the type of mobile device you use, your mobile devices unique device ID, the IP address of your mobile device, your mobile operating system, the type of mobile internet browsers you use, and information about the way you use the Website/Application/Services/products. We use an outside credit card processing company to bill you for goods and services.</p>

                            <p><strong>Use of your Personal Information</strong></p>

                            <p>We use the collected Information to analyse trends, to conduct research, to administer the Website/Application/Services and products, to learn about each user's learning patterns and movements around the Website/Application/Services and products and to gather demographic information and usage behaviour about our user base as a whole. Aggregated and individual, anonymized and non-anonymized data may periodically be transmitted to external service providers to help us improve the Website, Application, products and our Services. We will share your information with third parties only in the ways that are described below in this Policy. We may use the individual data and behavior patterns combined with personal information to provide you with personalized content, and better your learning objectives. Third parties provide certain services which we may use to analyze the data and information to personalize, drive insights and help us better your experience or reach out to you with more value added applications, products, information and services. However, these third party companies do not have any independent right to share this information. We do not sell, trade or share your Information to any third party (except subsidiaries/affiliates of the Company for related offerings) unless, we have been expressly authorized by you either in writing or electronically to do so. We may at times provide aggregate statistics about our customers, traffic patterns, and related site information to reputable third parties, however this information when disclosed will be in an aggregate form and does not contain any of your personally identifiable information. We will occasionally send email notices, messages or contact you to communicate about our Services, products and benefits, as they are considered an essential part of the Services/products you have chosen. We may disclose the Information:</p>

                            <ul>
                                <li>as required by law, such as to comply with summons, or similar legal process;</li>
                                ...
                                <li>to protect against imminent harm to the rights, property or safety of the Application/Website/ Acelot or its users or the public as required or permitted by law;</li>
                                ...
                                <li>Any portion of the Information containing personal data relating to minors provided by you shall be deemed to be given with the consent of the minor's legal guardian. Such consent is deemed to be provided by your registration with us.</li>
                            </ul>
                            ...
                            <p>We may alert you by email or phone (through SMS/call) to inform you about new service offerings of the Company and its subsidiaries/affiliates or other information which we feel might be useful for you, through the Company or its subsidiaries/affiliates.</p>
                            ...
                            <p>We believe that, every user of our Application/Services/products/Website must be in a position to provide an informed consent prior to providing any Information required for the use of the Application/Services/products/Website. By registering with us, you are expressly consenting to our collection, processing, storing, disclosing and handling of your information as set forth in this Policy now and as amended by us.</p>

                            <p><strong>Contact Information</strong></p>

                            <p>Our Grievance Officer shall undertake all reasonable efforts to address your grievances at the earliest possible opportunity. You may contact us at: Grievance Officer: 91 9205309509. Reach out to us on 91 9811949999, in case of any queries.</p>
                            <p></p>
                        </Col>
                    </Row>
                </Container>
